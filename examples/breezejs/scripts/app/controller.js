 ...
 */
todo.controller('TodoCtrl', function ($scope, $http, breeze, dataservice, logger) {
/*
    $http.get('index.cfm').success(function(data) {
         do nothing, just needed to kick off the CF app 
        console.log(data);
    });*/
