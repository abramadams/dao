...
/* 		this.setModified_Datetime(now());
	...
	**/
	...
	public function generateBreezeEntityType(){
		var breezeEntity = {
			"name" = "#getBreezeEntityName()#:#getBreezeNameSpace()#",
			"definition" = {
	            "shortName"= getBreezeEntityName(),
	            "namespace"= getBreezeNameSpace(),
	            "autoGeneratedKeyType"= "Identity",
	            "defaultResourceName"= getBreezeEntityName(),
	            "dataProperties"= generateBreezeProperties(),
