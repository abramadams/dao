<cfcomponent extends="testbox.system.testing.BaseSpec" displayname="MockBox Suite">
	...
	<cfscript>
		...
		function setup(){
			test = getMockBox().createEmptyMock( "testbox.samples.resources.Test" );
		}
		
		function testMockRealMethods(){
			Test = getMockBox().createMock( "testbox.samples.resources.Test" );
			test.getData();
		...
		function testSpys(){
			Test = createObject( "component", "testbox.samples.resources.Test" );
		...
		function testCollaborator(){
			Test = createObject( "component", "testbox.samples.resources.Test" );
			mockCollaborator = getMockBox().createMock( className="testbox.samples.resources.Collaborator", 
		                                             callLogging=true );
		...
		function testContainsCFKeyword(){
			test = getMockBox().createMock("testbox.samples.resources.Test");
			mockTest = getMockBox().createEmptyMock( "testbox.samples.resources.ContainsTest" )
				.$("contains", true);
		...
		function testInterfaceContracts(){
			mock = getMockBox().createMock( "testbox.samples.resources.MyInterfaceMock" );
