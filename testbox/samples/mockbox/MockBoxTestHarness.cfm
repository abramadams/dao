...
<cfset Test = mockBox.createMock("testbox.samples.resources.Test")>
...
<cfset Test = createObject("component","testbox.samples.resources.Test")>
...
<cfset Test = createObject("component","testbox.samples.resources.Test")>
<cfset mockCollaborator = MockBox.createMock(className="testbox.samples.resources.Collaborator",callLogging=true)>
