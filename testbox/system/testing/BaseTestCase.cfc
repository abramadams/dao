	...
	<cffunction name="beforeTests" hint="The main setup method for running ColdBox Integration enabled tests" output="false">
		...
		if( this.loadColdbox ){
			...
			if( structKeyExists(application,getColdboxAppKey()) ){
				...
				instance.controller = CreateObject("component", "testbox.system.testing.mock.web.MockController").init( appRootPath=appRootPath, appKey=instance.coldboxAppKey );
...
<!------------------------------------------- HELPERS ------------------------------------------->
	...
	<cffunction name="getMockDatasource" access="private" output="false" returnType="testbox.system.core.db.DatasourceBean" hint="I will return to you a datasourceBean according to the mocking parameters sent">
		...
		<cfscript>
			...
			return getMockBox().createMock("testbox.system.core.db.DatasourceBean").init(arguments);
		</cfscript>
	</cffunction>
	
	<!--- getMockConfigBean --->
	<cffunction name="getMockConfigBean" access="private" output="false" returnType="testbox.system.core.collections.ConfigBean" hint="I will return to you a configBean according to the mocking configuration structure you send in">
		<cfargument name="configStruct" type="struct" required="false" default="#structnew()#" hint="A memento of name-value pairs to init">
	    <cfscript>
			return getMockBox().createMock("testbox.system.core.collections.ConfigBean").init(arguments.configStruct);
		</cfscript>
	</cffunction>
	
	<!--- getMockRequestBuffer --->
	<cffunction name="getMockRequestBuffer" access="private" output="false" returnType="testbox.system.core.util.RequestBuffer" hint="I will return to you a mock request buffer object used mostly in interceptor calls">
	    <cfscript>
			return getMockBox().createMock("testbox.system.core.util.RequestBuffer").init();
		</cfscript>
	</cffunction>
	
	<!--- getMockController --->
	<cffunction name="getMockController" access="private" output="false" returnType="testbox.system.testing.mock.web.MockController" hint="I will return a mock controller object">
	    <cfscript>
			return CreateObject("component", "testbox.system.testing.mock.web.MockController").init('/unittest','unitTest');
		</cfscript>
	</cffunction>
		
	<!--- getMockRequestContext --->
	<cffunction name="getMockRequestContext" output="false" access="private" returntype="testbox.system.web.context.RequestContext" hint="Builds an empty functioning request context mocked with methods via MockBox.  You can also optionally wipe all methods on it.">
		...
		<cfscript>
			...
			if( arguments.clearMethods ){
				...
				return getMockBox().createEmptyMock("testbox.system.web.context.RequestContext");
			}
			
			// Create functioning request context
			mockRC 			= getMockBox().createMock("testbox.system.web.context.RequestContext");
			mockController = CreateObject("component", "testbox.system.testing.mock.web.MockController").init('/unittest','unitTest');
    ...
    <cffunction name="getMockPlugin" output="false" access="private" returntype="any" hint="Get a plugin mocked with capabilities">
    	...
    	<cfscript>
    		...
    		// Create Mock Objects
			var mockController 		= mockBox.createEmptyMock("testbox.system.testing.mock.web.MockController");
			var mockRequestService 	= mockBox.createEmptyMock("testbox.system.web.services.RequestService");
			var mockLogBox	 		= mockBox.createEmptyMock("testbox.system.logging.LogBox");
			var mockLogger	 		= mockBox.createEmptyMock("testbox.system.logging.Logger");
			var mockFlash		 	= mockBox.createMock("testbox.system.web.flash.MockFlash").init(mockController);
			var mockCacheBox   		= mockBox.createEmptyMock("testbox.system.cache.CacheFactory");
			var mockWireBox   		= mockBox.createEmptyMock("testbox.system.ioc.Injector");
	...
	<!--- getColdboxOCM --->
    <cffunction name="getColdboxOCM" access="private" output="false" returntype="any" hint="Get ColdboxOCM: testbox.system.cache.CacheManager or new CacheBox providers testbox.system.cache.IColdboxApplicationCache" colddoc:generic="testbox.system.cache.IColdboxApplicationCache">
	...
	<!--- getFlashScope --->
	<cffunction name="getFlashScope" output="false" access="private" returntype="testbox.system.web.Flash.AbstractFlashScope" hint="Returns to you the currently used flash ram object">
