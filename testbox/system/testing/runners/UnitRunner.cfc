...
*/ 
component extends="testbox.system.testing.runners.BaseRunner" implements="testbox.system.testing.runners.IRunner" accessors="true"{
	...
	*/
	any function run( 
		required any target,
		required testbox.system.testing.TestResult testResults 
	){
